...
package com.mycompany.top1_ys_thach_dau;
...
public class Top1_YS_Thach_Dau {
    static final int N = 200; // Số phần tử trong mảng
    static final int NUM_THREADS = 4; // Số luồng
